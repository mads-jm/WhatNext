...
export function TurnSetupModal({
    playlist,
    participants,
}: TurnSetupModalProps) {
            ...
            <div className="bg-surface border border-outline-variant rounded-xl shadow-2xl w-full max-w-md mx-4">
                <div className="p-6">
                    ...
                    <p className="text-sm text-on-surface-variant mb-6">
                        Collaborative playlists use turn-taking by default —
                        each person adds tracks in sequence, keeping things
                        balanced.
                    </p>
                    ...
                    <div className="mb-5">
                        ...
                        <div className="space-y-1">
                            {defaultOrder.map((userId, idx) => (
                                <div
                                    key={userId}
                                    className="flex items-center gap-2 px-2 py-1.5 rounded bg-surface-high/60"
                                >
                                    ...
                                    {idx === 0 && (
                                        <span className="ml-auto text-xs text-outline-variant">
                                            goes first
                                        </span>
                                    )}
                                </div>
                        ...
                        <p className="text-xs text-outline-variant mt-1.5">
                            Reorder anytime from the playlist view.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-6 mb-6">
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-base font-semibold text-on-surface w-5 text-center">
                                    {tracksPerTurn}
                                </span>
                                <button
                                    onClick={() =>
                                        setTracksPerTurn((n) => n + 1)
                                    }
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value={maxTurnsInput}
                                onChange={(e) =>
                                    handleMaxTurnsChange(e.target.value)
                                }
