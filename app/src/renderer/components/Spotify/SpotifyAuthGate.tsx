...
export function SpotifyAuthGate({
    connecting,
    error,
    onConnect,
    onCancel,
}: SpotifyAuthGateProps) {
    if (connecting) {
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-on-surface-variant mb-4">
                        ...
                        there, and you will be redirected back automatically.
                    </p>
                    <button
                        onClick={onCancel}
        ...
        <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center max-w-md">
                ...
                <p className="text-on-surface-variant mb-6">
                    Import your Spotify playlists into WhatNext. Your data stays
                    local -- we only read your playlist information.
                </p>
                <div className="space-y-3">
                    ...
                    <p className="text-xs text-on-surface-variant">
                        Uses OAuth PKCE -- no passwords are shared with
                        WhatNext. Requires a Spotify Client ID to be configured.
                    </p>
                </div>
                {error && (
