...
These should be consolidated and distilled into concept pages (`/docs/01 concepts/`), guides (`/docs/03 guides/`), or ADRs (`/docs/04 architecture/`) before any second-order or greater version release (e.g., v0.1.x → v0.2.0 or v1.2.x → v2.0.0).

> As such, this list should remain clear in `main` and only contain active notes in `dev` branches.
...
- [[note-251110-libp2p-first-implementation-learnings]]
- [[note-251110-libp2p-learning-roadmap]]
- [[note-251110-p2p-utility-process-architecture]]
- [[note-251110-simplified-p2p-connection-architecture]]
