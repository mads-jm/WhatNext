...
[[P2P-Discovery|mDNS peer discovery]] is limited to the local network. Friends on different LANs cannot connect without a publicly-reachable relay. This was the blocking issue for Milestone 1 (Remote Session Pairing) — see [[adr-260315-p2p-session-pairing]].
